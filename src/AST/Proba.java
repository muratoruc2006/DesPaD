...
public class Proba extends MyVisitor
{
   ...
   {	   	   
	    ...
	    * 099 : means this node has two edges and if this is edge, this is the second edge.
	    * 000 : means this node/edge will be unique.
	    */
	   
	   //-----FACTORY METHOD PATTERN-------
	   if (designpatternName == "FACTORY_METHOD"){	   
	   ...
	   if (designpatternName == "ABSTRACT_FACTORY"){	   
	   Nodes_Public = "v,1,Interface,000;v,2,Class,100;v,3,Class,100;v,4,Abstract,000";
	   Edges_Public = "e,2,1,implements,100;e,2,3,creates_objects_of,000;e,3,4,extends,100";
	   maxClassId = 4;}
	   ...
	   Edges_Public = "e,1,1,creates_objects_of,000;e,1,1,related_with_its_method,000;e,1,1,has_the_return_type_of,000";//;e,1,1,has_the_field_type_of,000";
	   maxClassId = 1;}
	   
	   //-----COMPOSITE PATTERN-------
	   if (designpatternName == "COMPOSITE"){	   
	   Nodes_Public = "v,1,Interface,000;v,2,Class,100;v,2,Class,099;v,3,Class,100";
	   Edges_Public = "e,2,1,implements,100;e,2,1,has_a_method_that_has_an_input_parameter_with_the_type_of,099;e,3,1,implements,100";
	   maxClassId = 3;}
	   
	   //-----FACADE PATTERN-------
	   if (designpatternName == "FACADE"){	   
	   Nodes_Public = "v,1,Class,000;v,2,Class,100;v,2,Class,099";
	   Edges_Public = "e,1,2,creates_objects_of,100;e,1,2,related_with_its_method,099";
	   maxClassId = 2;}
	   
	   //-----DECORATOR PATTERN-------
	   if (designpatternName == "DECORATOR"){ 	   
	   Nodes_Public = "v,1,Interface,000;v,2,Class,100;v,3,Abstract,000;v,4,Class,100";
	   Edges_Public = "e,2,1,implements,100;e,3,1,implements,000;e,3,1,related_with_its_method,000;e,4,3,extends,100";
	   maxClassId = 4;}
	   
	   //-----DECORATOR2 PATTERN-------
	   if (designpatternName == "DECORATOR2"){ 	   
	   Nodes_Public = "v,1,Interface,000;v,2,Class,100;v,3,Class,000;v,4,Class,100";
	   Edges_Public = "e,2,1,implements,100;e,3,1,implements,000;e,3,1,related_with_its_method,000;e,4,3,extends,100";
	   maxClassId = 4;}
	   ...
	   //-----FLYWEIGHT PATTERN-------
	   if (designpatternName == "FLYWEIGHT"){	   
	   Nodes_Public = "v,1,Class,100;v,2,Interface,000;v,3,Class,000;v,4,Class,100";
	   Edges_Public = "e,1,2,implements,100;e,3,2,has_the_field_type_of,000;e,4,3,calls_method_of,100";/*related_with_its_method*/
	   maxClassId = 4;}
	   
	   //-----ADAPTER PATTERN-------
	   if (designpatternName == "ADAPTER"){	   
	   Nodes_Public = "v,1,Interface,100;v,2,Class,000;v,3,Interface,000;v,4,Class,100";
	   Edges_Public = "e,2,1,related_with_its_method,100;e,2,3,implements,000;e,4,3,related_with_its_method,100";
	   maxClassId = 4;}
	   
	   //-----PROXY PATTERN-------
	   if (designpatternName == "PROXY"){	   
	   Nodes_Public = "v,1,Class,000;v,2,Interface,000;v,3,Class,000";
	   Edges_Public = "e,1,2,implements,000;e,3,2,implements,000;e,3,1,creates_objects_of,000";
	   maxClassId = 4;}
	   
	   //-----MEDIATOR PATTERN-------
	   if (designpatternName == "MEDIATOR"){	   
	   Nodes_Public = "v,1,Interface,000;v,2,Class,100;v,3,Class,000;v,4,Class,100";
	   Edges_Public = "e,2,1,implements,100;e,2,4,related_with_its_method,000;e,3,4,creates_objects_of,100;e,3,1,has_a_method_that_has_an_input_parameter_with_the_type_of,000";
	   maxClassId = 4;}
	   
	   //-----STATE PATTERN-------
	   if (designpatternName == "STATE"){	   
	   Nodes_Public = "v,1,Class,000;v,2,Interface,100;v,3,Class,100";
	   Edges_Public = "e,1,2,has_the_field_type_of,000;e,3,2,implements,100;e,1,3,creates_objects_of,100";
	   maxClassId = 3;}
	   
	   //-----OBSERVER PATTERN-------
	   if (designpatternName == "OBSERVER"){	   
	   Nodes_Public = "v,1,Class,000;v,2,Class,100;v,2,Class,099;v,3,Interface,000;v,4,Class,100";
	   Edges_Public = "e,1,3,has_a_method_that_has_an_input_parameter_with_the_type_of,000;e,4,3,implements,100;e,2,4,creates_objects_of,000;e,2,4,related_with_its_method,099;e,2,1,related_with_its_method,100";
	   maxClassId = 4;}
	   
	    //-----TEMPLATE METHOD PATTERN-------
	   if (designpatternName == "TEMPLATE_METHOD"){ 	   
	   Nodes_Public = "v,1,Abstract,000;v,2,Class,100;v,2,Class,099";
	   Edges_Public = "e,2,1,extends,100;e,2,1,overrides_methods_of,099";
	   maxClassId = 2;}
	   
	   //-----TEMPLATE METHOD2 PATTERN-------
	   if (designpatternName == "TEMPLATE_METHOD2"){ 	   
		   Nodes_Public = "v,1,Class,000;v,2,Class,100;v,2,Class,099";
		   Edges_Public = "e,2,1,extends,100;e,2,1,overrides_methods_of,099";
		   maxClassId = 2;}
	   	 
	   //-----COMMAND PATTERN-------
	   if (designpatternName == "COMMAND"){ 	   
		   Nodes_Public = "v,1,Class,100;v,2,Class,000;v,3,Interface,000;v,4,Class,100";
		   Edges_Public = "e,2,1,has_a_method_that_has_an_input_parameter_with_the_type_of,100;e,2,3,implements,000;e,4,3,related_with_its_method,100";
		   maxClassId = 4;}
	   
	   //-----CHAIN_OF_RESPONSIBILITY PATTERN-------
	   if (designpatternName == "CHAIN_OF_RESPONSIBILITY"){ 	   
		   Nodes_Public = "v,1,Class,100;v,2,Interface,000;v,3,Class,100;v,3,Class,099";
		   Edges_Public = "e,1,2,related_with_its_method,100;e,2,2,has_a_method_with_the_return_type_of,000;e,3,2,implements,100;e,3,2,related_with_its_method,099";
		   maxClassId = 3;}
	   
	   //-----INTERPRETER PATTERN-------
	   if (designpatternName == "INTERPRETER"){ 	   
		   Nodes_Public = "v,1,Class,100;v,2,Class,000;v,3,Interface,000;v,4,Class,100";
		   Edges_Public = "e,1,2,creates_objects_of,100;e,3,2,has_a_method_that_has_an_input_parameter_with_the_type_of,000;e,4,3,implements,100";
		   maxClassId = 4;}
	    
	   //-----MEMENTO PATTERN-------
	   if (designpatternName == "MEMENTO"){ 	   
		   Nodes_Public = "v,1,Class,000;v,2,Class,000;v,3,Class,100";
		   Edges_Public = "e,1,2,creates_objects_of,000;e,1,2,related_with_its_method,099;e,3,1,creates_objects_of,100";
		   maxClassId = 3;}
	   
	   //-----ITERATOR PATTERN-------
	   if (designpatternName == "ITERATOR"){ 	   
		   Nodes_Public = "v,1,Interface,000;v,2,Class,100;v,3,Class,100;v,4,Interface,000";
		   Edges_Public = "e,2,1,implements,100;e,3,4,has_a_method_with_the_return_type_of,100;e,3,2,calls_method_of,099";
		   maxClassId = 4;}
	   
	   //-----STRATEGY PATTERN-------
	   if (designpatternName == "STRATEGY"){ 	   
		   Nodes_Public = "v,1,Class,000;v,2,Interface,000;v,3,Class,100";
		   Edges_Public = "e,1,2,creates_objects_of,000;e,1,2,has_a_method_that_has_an_input_parameter_with_the_type_of,099;e,3,2,implements,100";
		   maxClassId = 3;}
	   
	   //-----VISITOR PATTERN-------
	   if (designpatternName == "VISITOR"){ 	   
		   Nodes_Public = "v,1,Interface,000;v,2,Class,100;v,3,Interface,000;v,4,Class,100;v,5,Class,000";
		   Edges_Public = "e,2,1,implements,100;e,4,3,implements,100;e,3,1,has_a_method_that_has_an_input_parameter_with_the_type_of,000;e,5,4,creates_objects_of,000";
		   maxClassId = 5;}
...
//	   }
	   ...
	   // node lardan duplicate olanlari eliyoruz.
	  ...
	  Iterator iterator_dugumler = d.dugumler.iterator();
	  int baslangic =1;
	  ...
	  while (iterator_dugumler.hasNext())
      {
          ...
          else
          {
              ...
              while (iterator_dugumler2.hasNext())
              {
	    	  		...
	    	  		//System.out.println(o.getNode1()+"-"+o.getNode2()+"-"+o.getRelation());
	    	  		//System.out.println(o2.getNode1()+"-"+o2.getNode2()+"-"+o2.getRelation());
	  ...
	  //"dugumler2" i "SUBDUE" graph mining tooluna girecek sekilde dolduruyoruz. (nodelar ve aralarindaki iliskiler)
	...
	final List<Nodes> X = new ArrayList<Nodes>();
   	...
   	if (designPatternGraph == true )	{ 
		...
		for (int i = 0; i < Edges_All_tokens.length; i++)
		{
			...
			if(Edges_All_tokens_[4].equals("099")){
				SecondRelation = Edges_All_tokens_[3].toString();
			}		
		}
		...
		//BURADA INPUT OLARAK SABIT ILISKIYI VERIP KAC CLASS IN INPUT PROJEDE BU ILISKIYI MAKSIMUM ICERDIGINI BULUYORUZ.
	  	String Relation;
	  	String ClassOrder="0";
	...
	//		System.out.println("count : "+ vertices.getId() +" name : " + vertices.getName() + " murat");}
		...
		for (String s : removeDuplicates(BaseVertex))
			writer.println(s.replace(",", " "));
		for (String s : removeDuplicates(BaseEdges))
			writer.println(s.replace(",", " "));
		writer.close();
		...
		{
			mxc = maxClassId;
			path2 = programPath+"/Projects/" + projectName + "/inputs/" + designpatternName + "_inputs/" + designpatternName + "_" + gen +".g";
			PrintWriter writer2 = new PrintWriter(path2);						
			...
			{			
				...
				while (ekle <= N)
				{
					...
					{
						path3 = programPath+"/Projects/" + projectName + "/inputs/" + designpatternName + "_inputs/" + designpatternName + "_" + gen +".g";
						PrintWriter writer3 = new PrintWriter(path3);
				...
				{
					mxc++;
					String rel = Medge.replace(Medge.substring(2,3), mxc.toString());
					writer2.println(rel);
					
					if(!SecondRelation.equals("")){
						String reverse = new StringBuffer(rel).reverse().toString();
						String s = reverse.replace(reverse.substring(0,reverse.indexOf(" ", 0)),"");
						String reverse_ = new StringBuffer(s).reverse().toString();
						writer2.println(reverse_+SecondRelation);
						System.out.println("%"+reverse_+SecondRelation);
						}
					System.out.println("%"+Medge.replace(Medge.substring(2,3), mxc.toString()));
					p++;
				}
		...
		for (int i = 0; i < M ; i++)
		{
			path4 = programPath+"/Projects/" + projectName + "/inputs/" + designpatternName + "_inputs/" + designpatternName + "_" + gen +".g";
			PrintWriter writer4 = new PrintWriter(path4);
			...
			{
				mxc++;
				String _rel = Medge.replace(Medge.substring(2,3), mxc.toString());
				writer4.println(_rel);
				
				if(!SecondRelation.equals("")){
					String _reverse = new StringBuffer(_rel).reverse().toString();
					String _s = _reverse.replace(_reverse.substring(0,_reverse.indexOf(" ", 0)),"");
					String _reverse_ = new StringBuffer(_s).reverse().toString();
					writer4.println(_reverse_+SecondRelation);
					}
		...
		if (N != 0)
		{
			...
			for (int i = 0; i < N ; i++)
			{
				path5 = programPath+"/Projects/" + projectName + "/inputs/" + designpatternName + "_inputs/" + designpatternName + "_" + gen +".g";
				PrintWriter writer5 = new PrintWriter(path5);
		...
		if (OnlyTerminalCommands==true){
			if (M > 0 && N > 0)
		   	{		
				...
				writer6.println();
				writer6.println(programPath+"/Subdue/sgiso -dot "+programPath+"/Projects/"+projectName+"/outputs/"+designpatternName+"_outputs/out1.g "+overlap+" "+"-threshold "+threshold+" "+programPath+"/Projects/"+projectName+"/inputs/"+designpatternName+"_inputs/"+designpatternName+"_1.g "+programPath+"/Projects/"+projectName+"/source/"+projectName+".g");			
				writer6.println();
			...
			else if (M > 0 && N <= 0)
		   	{
				...
				writer7.println();
				writer7.println(programPath+"/Subdue/sgiso -dot "+programPath+"/Projects/"+projectName+"/outputs/"+designpatternName+"_outputs/out1.g "+overlap+" "+" -threshold "+threshold+" "+programPath+"/Projects/"+projectName+"/inputs/"+designpatternName+"_inputs/"+designpatternName+"_1.g "+programPath+"/Projects/"+projectName+"/source/"+projectName+".g");			
				writer7.println();
				writer7.println("#first_loop(M combination)");
				writer7.println("for (( c=2" + "; c<=" + (M+2) + "; c++ ))");
				writer7.println("do");
				writer7.println(programPath+"/Subdue/sgiso -dot "+programPath+"/Projects/"+projectName+"/outputs/"+designpatternName+"_outputs/out$c.g -threshold "+threshold+" "+programPath+"/Projects/"+projectName+"/inputs/"+designpatternName+"_inputs/"+designpatternName+"_$c.g "+programPath+"/Projects/"+projectName+"/source/"+projectName+".g");
				writer7.println();			
				...
				writer7.println("break;");
				writer7.println("fi");
				writer7.println("done<"+programPath+"/Projects/"+projectName+"/outputs/"+designpatternName+"_outputs/out$c.g");
				...
				PrintWriter writer8 = new PrintWriter(programPath+"/Projects/" + projectName + "/" + "batch/script_" + designpatternName + ".sh" );
				writer8.println("#! /bin/bash");
				writer8.println();
				writer8.println("#initilization");
				writer8.println();
				writer8.println(programPath+"/Subdue/sgiso -dot "+programPath+"/Projects/"+projectName+"/outputs/"+designpatternName+"_outputs/out1.g "+overlap+" "+" -threshold "+threshold+" "+programPath+"/Projects/"+projectName+"/inputs/"+designpatternName+"_inputs/"+designpatternName+"_1.g "+programPath+"/Projects/"+projectName+"/source/"+projectName+".g");			
				writer8.println();
				writer8.println(programPath+"/Subdue/graph2dot "+programPath+"/Projects/"+projectName+"/source/"+projectName+".g "+programPath+"/Projects/"+projectName+"/source/"+projectName+".dot");
				writer8.println();
				writer8.println();
				writer8.close();
